                ...
                <section class="container mt-5 ml-5 mr-5 mb-5" style="padding-left: 50; padding-right: 50;">
                    ...
                    ?>
                        <div class="card-img-top" style="overflow: hidden;height: 100%">
                            <img src="assets/img/<?= $hasil["gambar"] ?>" alt="" style="object-position: center;object-fit: fill;max-width: 100%">
                        </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row d-flex justify-content-center">
                                <div class="form-group fw-bold mb-4">
                                    ...
                                    <input type="text" class="form-control" value="<?= $hasil["judul_buku"] ?>" name="judul_buku" required id="judul_buku">
                                </div>
                                <div class="form-group mb-4 fw-bold">
                                    <label for="penulis_buku">Penulis</label>
                                    <input type="text" class="form-control" value="<?= $hasil["penulis_buku"] ?>" name="penulis_buku" required id="penulis_buku" readonly>
                                </div>
                                <div class="form-group mb-4 fw-bold">
                                    <label for="tahun_terbit">Tahun Terbit</label>
                                    <input type="number" class="form-control" value="<?= $hasil["tahun_terbit"] ?>" name="tahun_terbit" required id="tahun_terbit">
                                </div>
                                <div class="form-group mb-4 fw-bold">
                                    <label for="deskripsi">Deskripsi</label>
                                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4"><?= $hasil["deskripsi"] ?></textarea>
                                </div>
