                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="card-body">
                            <div class="form-group fw-bold mb-4">
                                ...
                                <input type="text" class="form-control" name="judul_buku" placeholder="Contoh: Pemograman web bersama EAD" required id="judul_buku">
                            </div>
                            <div class="form-group mb-3 fw-bold mb-4">
                                <label for="penulis_buku"> Penulis </label>
                                <input type="text" class="form-control" value="<?= $penulis ?>" name="penulis_buku" required id="penulis_buku" readonly>
                            </div>
                            <div class="form-group mb-3 fw-bold mb-4">
                                <label for="tahun_terbit"> Tahun Terbit </label>
                                <input type="number" class="form-control" name="tahun_terbit" placeholder="Contoh: 1990" required id="tahun_terbit">
                            </div>
                            <div class="form-group mb-3 fw-bold mb-4">
                                <label for="deskripsi"> Deskripsi </label>
                                <textarea name="deskripsi" id="deskripsi" placeholder="Contoh: Buku ini menjelaskan tentang..." class="form-control" rows="4"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-5 text-center">
                                    <button type="submit" name="submit" class="btn btn-primary mr-1" style="padding-left: 300px; padding-right: 300px;">+ TAMBAH</button>
                                </div>
                            </div>
                        </div>
                    </div>
