                    ...
                    <div class="row py-3 px-3">
                        ...
                        <div class="col-lg">
                            <form class="booking" action="myBooking.php" id="booking" method="post">
                                ...
                                <input type="text" class="form-control" name="nama" id="name" value="Sekar_1202194317" readonly>

                                <label for="date" class="my-2">Event Date</label>
                                <input type="date" class="form-control" name="tanggal" id="date" placeholder="mm/dd/yyyy" required>

                                <label for="time" class="my-2">Start Time</label>
                                <input type="time" class="form-control" name="waktu" id="time" placeholder="--:-- --" required>

                                <label for="duration" class="my-2">Duration (Hours)</label>
                                <input type="number" class="form-control" name="durasi" id="duration" placeholder="0" required>
