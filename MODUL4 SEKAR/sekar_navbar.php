        ...
        <ul class="navbar-nav">
            ...
            if (!isset($_SESSION['logged_in'])) {
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle nav-link-lg nav-link-user" id="navbarDropdown" role="button"
                       data-bs-toggle="dropdown" aria-expanded="false" href="#">
                        <div class="d-sm-none d-lg-inline-block text-primary text-dark"><?php echo $_SESSION['nama'] ?></div>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item"
                               href="sekar_profile.php?id=<?php echo $_SESSION['id'] ?>">Profile</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <form action="index.php" method="post">
                            <li>
                                <button class="dropdown-item" type="submit" name="btn_logout">Logout</button>
                            </li>
                        </form>
                    </ul>
                </li>
