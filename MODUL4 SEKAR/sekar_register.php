...
if (isset($_POST['submit'])) {
    ...
    if ($insert) {
        ...
        header("Location: sekar_register.php");
        exit();
    } else {
...
if (isset($SESSION['message'])) {
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert"> ' . $SESSION["message"] . ' <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
                ...
                <div class="card-body px-5 pt-4">
                    ...
                    <form action="sekar_register.php" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="password" required class="form-control" name="password" id="passw"
                                   placeholder="Kata Sandi Anda">
                        </div>
                        <div class="form-group mb-3">
                            <label for="conf_passw">Konfirmasi Kata Sandi</label>
                            <input type="password" required class="form-control" name="conf_passw" id="conf_passw"
